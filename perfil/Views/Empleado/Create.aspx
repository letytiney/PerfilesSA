<%@ Page Title="Crear Empleado" Language="C#" MasterPageFile="~/Site.Master" 
                        ...
                        <% using (Html.BeginForm("Create", "Empleado", FormMethod.Post)) { %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <%= Html.TextBoxFor(m => m.FechaIngreso, new { @class = "form-control", type = "date" }) %>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-center">
                                    <input type="submit" value="Crear" class="btn bg-success text-white px-4" />
